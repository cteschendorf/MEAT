 ...
 * sizes five labels do not fit a phone's width, and a tab whose text is
 * clipped to three letters is not a tab anyone can use.
 */
            ...
            >
              <Text
                ...
                style={[
                  ...
                  {
                    // A tab with nothing behind it reads as available but
                    // quieter, which is what it is.
                    color: selected
                      ? colors.brandStrong
                      : ready
                        ? colors.textPrimary
